            ...
            <div id="invoice-footer">
              <div class="row">
                ...
                <div class="col-md-5 col-sm-12 text-center">
                  <form action="<?php echo base_url('dashboard/send_invoice/'.$pend_inv->invoice_id); ?>" method="post">
                    <input type="hidden" name="invoice_id" value="<?php echo $pend_inv->invoice_id?>">
                    <input type="hidden" name="receiver_email" value="<?php echo $pend_inv->receiver_email?>">
