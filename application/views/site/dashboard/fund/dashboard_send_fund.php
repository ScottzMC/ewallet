...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    <title>E-Wallet || Send Funds Payments</title>
  </head>
            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Send Funds
                  </li>
                </ol>
              </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form action="<?php echo base_url('dashboard/send_fund'); ?>" method="post" id="paymentForm" class="card-form">
                            <div class="row">
                              <div class="col-md-4 col-sm-4">
                                  <div class="form-group">
                                      ...
                                      <input class="form-control" id="email" name="reciever_email" placeholder="Enter Receiver Email" type="text">
                                      <small style="font-size: 12px; color: red;">Receiver Email</small>
                                  </div>
                                  <span class="text-danger" style="color: red;"><?php echo form_error('receiver_email'); ?></span>
                              </div>
