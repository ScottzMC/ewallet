...
<head>
  ...
  <title>E-Wallet || Login to your Account</title>
              ...
              <div class="card border-grey border-lighten-3 m-0">
                ...
                <div class="card-content">
                  ...
                  <div class="card-body pt-0">
                    <form class="form-horizontal" action="<?php echo base_url('login'); ?>" method="post">
                      <fieldset class="form-group position-relative has-icon-left">
                        <input type="text" class="form-control input-lg" id="user-name" name="email" placeholder="Your Email Address"
                        required>
                  ...
                  <div class="card-body pb-0">
                    ...
                    <p class="text-center">New to Modern Admin? <a href="<?php echo site_url('register'); ?>" class="card-link">Create Account</a></p>
                  </div>
